...
<html>
	...
	<body>
	<!--内容显示 √ 导航与查询√ 登陆注册 √ 用户笔记√ 友情链接 √ 反馈建议 √ 后台管理√ -->
	...
	<!--反馈与建议 (7)-->
	<div class="xuanfu">
		<a class="fankui" href="#" onclick="warning()">
		反馈与建议
		</a>
	</div>
	...
	if(<%=session.getAttribute("username") %> != null){
		window.location.reload("welcome.jsp");
	}
	
	function warning(){
		alert("登陆后才能访问, 请先登陆!");
		window.location.reload("login.jsp");
	}
